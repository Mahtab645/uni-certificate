...
<section class="inner-hero">
    ...
    <div class="container">
        ...
        <p>Reach our Berlin office by phone, email or the enquiry form. We respond during business hours.</p>
    </div>
</section>

<section class="page-connect" id="contact">
    <div class="container">
        <div class="info-tiles">
            ...
            <article class="info-tile">
                ...
                <p class="info-tile-note">Monday–Friday, 09:00–17:00 CET</p>
            </article>
            <article class="info-tile">
            ...
            <article class="info-tile">
                ...
                <p class="info-tile-note">General enquiries</p>
            </article>
        </div>
        ...
        <div class="connect-split">
            <div class="connect-intro">
                ...
                <p>Whether you need a first proposal, a transfer of certification or a technical question — describe your request in as much detail as possible so we can route it to the right team.</p>
                <ul class="connect-points">
                    <li>Independent certification under internationally recognized standards</li>
                    <li>Clear procedures from application to certificate decision</li>
                    <li>A dedicated contact in Berlin for national and international clients</li>
                </ul>
            </div>
...
<section class="map-band">
    <div class="container map-band-head">
        <p class="section-kicker">Location</p>
        <h2>Find us in Berlin</h2>
        <p>Neukirchstraße 26, 13089 Berlin, Germany</p>
    </div>
    <div class="map-frame">
        <iframe
