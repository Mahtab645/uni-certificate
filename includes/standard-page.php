...
if (empty($standardSlug)) {
    header('Location: certifications.php', true, 302);
    exit;
}
...
if (!$standard) {
    ...
    <section class="inner-hero about-page-hero">
        <div class="container">
            ...
            <p>Please return to the overview of certification standards.</p>
        </div>
    </section>
    <section class="inner-section">
        <div class="container">
            <a class="btn-olive" href="<?php echo htmlspecialchars($baseUrl . '/certifications.php', ENT_QUOTES, 'UTF-8'); ?>">All standards</a>
        </div>
    </section>
    <?php
...
<nav class="about-jump" aria-label="Breadcrumb">
    <div class="container about-jump-inner">
        <a href="<?php echo htmlspecialchars($baseUrl . '/certifications.php', ENT_QUOTES, 'UTF-8'); ?>">Certification standards</a>
